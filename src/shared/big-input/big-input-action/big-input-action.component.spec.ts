...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<jptr-big-input-action></jptr-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<jptr-big-input-action [disabled]="true"></jptr-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<jptr-big-input-action fontSet="fas" fontIcon="trash"></jptr-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<jptr-big-input-action label="delete"></jptr-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<jptr-big-input-action (action)="actionHandler()"></jptr-big-input-action>';
    fixture = createHostComponent(template);
